...
import { SettingsComponent } from '../lib/theme-selector/component/settings/settings.component';
import { BaseComponent } from '../lib/theme-selector/base.component';
import { RouterModule } from '@angular/router';

@Component({
  selector: 'app-hero',
  standalone: true,
  imports: [CommonModule, SettingsComponent, RouterModule],
  template: `
    ...
    <section class="">
      <div [ngClass]="['bg' + primary]">
        <div
          ...
          [ngClass]="['text' + dark]">
          <h1 class="text-5xl font-bold leading-none sm:text-6xl xl:max-w-3xl" [ngClass]="['text' + contrast]">
            @rickzhou/ngx-cdk
          </h1>
          <p class="mt-6 mb-8 text-lg sm:mb-12 xl:max-w-3xl font-serif italic" [ngClass]="['text' + contrast]">
            Angular Components Development Kits
          </p>
          <div class="flex flex-wrap justify-center">
            ...
            <a
              ...
              target="_blank"
              href="https://github.com/rick-chou/ngx-cdk">
              Github
            </a>
          </div>
        </div>
    ...
    <footer class="dark:bg-gray-800 dark:text-gray-50">
      <div class="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row divide-gray-400">
        <ul
          class="self-center py-6 space-y-4 text-center sm:flex sm:space-y-0 sm:justify-around sm:space-x-4 lg:flex-1 lg:justify-start"></ul>
        <div class="flex flex-col justify-center pt-6 lg:pt-0">
          <div class="flex justify-center space-x-4">
            <a
              rel="noopener noreferrer"
              href="mailto:rickzhou209@gmail.com"
              title="Gmail"
              class="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-red-400 dark:text-gray-900">
